      ...
      # E repito o evento até a data "<data_fim_evento>"
      # E gero a lista de participantes

      # E escolho o participante com os parâmetros:
      # | ordem_grid | dia            |
      # | 1          | Seg 04/05/2020 |
      ...
      # E escolho o participante "1" da grid para o dia "Seg 04/05/2020"
      # E escolho o participante "1" da grid para o dia "Ter 05/05/2020"
      # E escolho o participante "1" da grid para o dia "Qua 06/05/2020"
      E informo a descrição do evento com os parâmetros:
      | descricao                                                                                       |
      | Evento teste do Cypress Evento teste do Cypress Evento teste do Cypress Evento teste do Cypress |
      # E salvo o evento
      ...
      Exemplos:
      | tipo_evento | tipo_demanda | data_evento | data_fim_evento | hora_inicial |
      | Mutirão     | Processual   | 2020-05-04  | 2020-05-06      | 14:00        |
