...
Funcionalidade: Validações Agenda
  ...
  @agenda
  Esquema do Cenário: Criar um registro com Tipo de Evento Atendimento e Tipo de Demanda Pré Processual / Processual
...
@agenda
  Esquema do Cenário: Criar um registro com Tipo de Evento Mutirão e Tipo de Demanda Processual / Cidadania
    Dado eu abro a página de Agendar Evento
    ...
    E repito o evento até a data "data_fim"
    ...
    # Entao valido que o evento foi salvo 
      ...
      Exemplos:
      | tipo_evento | tipo_demanda | numero_processo | data_evento | hora_inicial |
      | Mutirão     | Processual   |                 | 2020-08-29  | 14:00        |
